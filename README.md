...
- **60 builtin rules** across secrets, SQL/NoSQL injection, XSS, auth, LLM-specific risks, misconfiguration, Docker, and IaC. Detects across **10 languages** via an optional Semgrep adapter.
...
**60 rules** across eight categories, targeting the failure modes we see most often in AI-generated web code:
