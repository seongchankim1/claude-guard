...
- **140 builtin rules** across secrets, SQL/NoSQL injection, XSS, auth, LLM-specific risks, misconfiguration, Docker, and IaC. Detects across **10 languages** via an optional Semgrep adapter.
...
**140 rules** across eight categories, targeting the failure modes we see most often in AI-generated web code:
...
| Rule catalogue size | 140 | 2000+ | secrets-only | thousands | thousands |
