# claude-guard Implementation Plan (HISTORICAL)

> **NOTE (2026-04-20):** This plan is the **v0.1 breakdown** kept for history.
> The shipped architecture evolved past it:
> - No L3 layer — redteam is an opt-in MCP tool, not a scan stage.
> - Engine is 2 layers: L1 (semgrep/gitleaks, auto) and L2 (built-in YAML).
> - Rule catalog is 155 rules, not the initial 10 planned here.
>
> Source of truth is the code under `src/` and `docs/SECURITY_MODEL.md`.
